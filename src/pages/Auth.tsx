      ...
      <form onSubmit={handle} className="w-full max-w-sm space-y-4 border border-border p-6 rounded">
        ...
        <div className="space-y-2">
          ...
          <Button
            ...
            disabled={busy}
            onClick={handleApple}
            className="w-full flex items-center justify-center gap-2 bg-foreground text-background hover:bg-foreground/90 hover:text-background"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.22 7.13-.57 1.5-1.31 2.99-2.27 4.08zm-5.85-15.1c.07-2.04 1.76-3.79 3.74-3.82.29 2.32-1.94 4.48-3.74 3.82z" />
            </svg>
            Sign in with Apple
          </Button>
        </div>
